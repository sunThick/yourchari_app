...
// tupleを用いて自転車のpostIdからChariとFirestoreUserをreturn
    FutureProvider.autoDispose
        .family<Tuple2<DocumentSnapshot<Map<String, dynamic>>, FirestoreUser>, String>(((ref, uid) async {
  final chariDoc =
  ...
  final chariAndPassiveUser = Tuple2<DocumentSnapshot<Map<String, dynamic>>, FirestoreUser>(chariDoc, passiveUser);
